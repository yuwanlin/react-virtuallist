...
function VirtualList(props: VirtualListProps) {
  ...
  useEffect(() => {
    ...
    updateListBoxHeight(window.pageYOffset)
  ...
  const updateListBoxHeight = (scrollTop: number) => {
    ...
    console.log('aaa', lastScrollItemPosition.current.top - lastBeforeBufferItemPosition.current.top)
