...
function VirtualList(props: VirtualListProps) {
  ...
  const lastBeforeBufferItemPosition = useRef<ItemPosition>();
  console.log("TCL: VirtualList -> lastBeforeBufferItemPosition", lastBeforeBufferItemPosition)
  ...
  const updateListBoxHeight = () => {
    ...
    console.log('aaa', list.length, endIndex)
