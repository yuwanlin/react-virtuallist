...
function VirtualList(props: VirtualListProps) {
  ...
  const updateStartIndex = (scrollTop: number) => {
    ...
    startIndexRef.current = targetItemPosition.index - beforeBuffer >= 0 ? targetItemPosition.index : 0
  }
  ...
  const updateVisibleList = (scrollTop: number) => {
    ...
    console.log('aaa', lastScrollItemPosition.current, lastBeforeBufferItemPosition.current)
